...
export const CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN_CLONE =
    `${CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN}/clone`;
export const CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN_RENAME =
    `${CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN}/rename`;
export const CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN_SYNC =
    `${CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN}/synchronizeClients`;

export const CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN_SYNCLOG =
    `${CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN}/synclog`;
export const CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN_CHANGELOG =
    `${CONTRACT_DATA_PRODUCT_DOMAIN_SEGMENTS_DOMAIN}/changelog`;
